...
Object-oriented programming is deeply embedded in Python. Many of the main data types (such as strings, lists, and dictionaries) are objects in Python, and have their own associated methods. The standard library also defines several classes for different purposes, and users also have the option of defining their own classes.
